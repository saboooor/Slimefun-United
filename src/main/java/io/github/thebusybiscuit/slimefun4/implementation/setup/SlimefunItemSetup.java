...
public final class SlimefunItemSetup {
    ...
    public static void setup(@Nonnull Slimefun plugin) {
        ...
        new DietCookie(itemGroups.food, SlimefunItems.DIET_COOKIE, RecipeType.MAGIC_WORKBENCH, new ItemStack[] {
                    new ItemStack(Material.COOKIE),
                    SlimefunItems.ELYTRA_SCALE.item(),
                    null,
                    null,
                    null,
                    null,
        ...
        new UnplaceableBlock(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.BASIC_CIRCUIT_BOARD.item(),
                            new ItemStack(Material.REDSTONE_BLOCK),
                            new ItemStack(Material.LAPIS_BLOCK),
                            new ItemStack(Material.LAPIS_BLOCK),
                            new ItemStack(Material.LAPIS_BLOCK)
        ...
        registerArmorSet(
                ...
                new ItemStack[] {
                    SlimefunItems.GLOWSTONE_HELMET.item(),
                    SlimefunItems.GLOWSTONE_CHESTPLATE.item(),
                    SlimefunItems.GLOWSTONE_LEGGINGS.item(),
                    SlimefunItems.GLOWSTONE_BOOTS.item()
                },
                "GLOWSTONE",
                false,
                new PotionEffect[][] {
        ...
        new RainbowArmorPiece(
                        ...
                        RecipeType.ARMOR_FORGE,
                        new ItemStack[] {
                            SlimefunItems.RAINBOW_LEATHER.item(),
                            SlimefunItems.RAINBOW_LEATHER.item(),
                            SlimefunItems.RAINBOW_LEATHER.item(),
                            SlimefunItems.RAINBOW_LEATHER.item(),
                            null,
        ...
        registerArmorSet(
                ...
                new ItemStack[] {
                    SlimefunItems.DAMASCUS_STEEL_HELMET.item(),
                    SlimefunItems.DAMASCUS_STEEL_CHESTPLATE.item(),
                    SlimefunItems.DAMASCUS_STEEL_LEGGINGS.item(),
                    SlimefunItems.DAMASCUS_STEEL_BOOTS.item()
                },
                "DAMASCUS_STEEL",
                false,
        ...
        registerArmorSet(
                ...
                new ItemStack[] {
                    SlimefunItems.REINFORCED_ALLOY_HELMET.item(),
                    SlimefunItems.REINFORCED_ALLOY_CHESTPLATE.item(),
                    SlimefunItems.REINFORCED_ALLOY_LEGGINGS.item(),
                    SlimefunItems.REINFORCED_ALLOY_BOOTS.item()
                },
                "REINFORCED_ALLOY",
                false,
                new PotionEffect[0][0],
        ...
        registerArmorSet(
                ...
                new ItemStack[] {
                    SlimefunItems.CACTUS_HELMET.item(),
                    SlimefunItems.CACTUS_CHESTPLATE.item(),
                    SlimefunItems.CACTUS_LEGGINGS.item(),
                    SlimefunItems.CACTUS_BOOTS.item()
                },
                "CACTUS",
                false,
                new PotionEffect[0][0],
        ...
        new SlimefunItem(
                        ...
                        new ItemStack[] {
                            SlimefunItems.CARBON_CHUNK.item(), null, null, null, null, null, null, null, null
                        })
                .setUseableInWorkbench(true)
                .register(plugin);

        new SlimefunItem(itemGroups.resources, SlimefunItems.RAW_CARBONADO, RecipeType.SMELTERY, new ItemStack[] {
                    SlimefunItems.SYNTHETIC_DIAMOND.item(),
        ...
        new SlimefunItem(itemGroups.resources, SlimefunItems.CARBONADO, RecipeType.PRESSURE_CHAMBER, new ItemStack[] {
                    SlimefunItems.RAW_CARBONADO.item(), null, null, null, null, null, null, null, null
                })
                .register(plugin);
        ...
        new SlimefunItem(itemGroups.resources, SlimefunItems.COPPER_DUST, RecipeType.ORE_WASHER, new ItemStack[] {
                    SlimefunItems.SIFTED_ORE.item(), null, null, null, null, null, null, null, null
                })
                .register(plugin);
        ...
        new SlimefunItem(itemGroups.misc, SlimefunItems.STEEL_PLATE, RecipeType.COMPRESSOR, new ItemStack[] {
                    new SlimefunItemStack(SlimefunItems.STEEL_INGOT, 8).item(),
                    null,
                    null,
                    null,
                    null,
        ...
        new UnplaceableBlock(
                        itemGroups.resources, SlimefunItems.COMPRESSED_CARBON, RecipeType.COMPRESSOR, new ItemStack[] {
                            new SlimefunItemStack(SlimefunItems.CARBON, 4).item(),
                            null,
                            null,
                            null,
                            null,
        ...
        new SteelThruster(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.ALUMINUM_BRONZE_INGOT.item(),
                            SlimefunItems.ALUMINUM_BRONZE_INGOT.item(),
                            SlimefunItems.STEEL_PLATE.item(),
        ...
        new Jetpack(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.DURALUMIN_INGOT.item(),
                            SlimefunItems.DURALUMIN_INGOT.item(),
                            SlimefunItems.POWER_CRYSTAL.item(),
                            SlimefunItems.DURALUMIN_INGOT.item(),
                            SlimefunItems.STEEL_THRUSTER.item(),
        ...
        new Jetpack(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.REINFORCED_ALLOY_INGOT.item(),
                            SlimefunItems.STEEL_THRUSTER.item(),
                            SlimefunItems.MEDIUM_CAPACITOR.item(),
                            SlimefunItems.STEEL_THRUSTER.item()
                        },
                        0.6,
                        100)
        ...
        new Jetpack(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.CARBONADO.item(),
                            SlimefunItems.STEEL_THRUSTER.item(),
                            SlimefunItems.LARGE_CAPACITOR.item(),
                            SlimefunItems.STEEL_THRUSTER.item()
                        },
                        0.7,
                        150)
        ...
        new Parachute(
                        ...
                        RecipeType.ENHANCED_CRAFTING_TABLE,
                        new ItemStack[] {
                            SlimefunItems.CLOTH.item(),
                            SlimefunItems.CLOTH.item(),
                            SlimefunItems.CLOTH.item(),
                            SlimefunItems.CHAIN.item(),
                            null,
                            SlimefunItems.CHAIN.item(),
                            null,
                            null,
        ...
        new SlimefunItem(
                        ...
                        new ItemStack[] {
                            null,
                            SlimefunItems.MAGICAL_BOOK_COVER.item(),
        ...
        new WindStaff(itemGroups.magicalGadgets, SlimefunItems.STAFF_WIND, RecipeType.MAGIC_WORKBENCH, new ItemStack[] {
                    ...
                    SlimefunItems.ENDER_LUMP_3.item(),
                    null,
                    SlimefunItems.STAFF_ELEMENTAL.item(),
                    new ItemStack(Material.FEATHER),
                    SlimefunItems.STAFF_ELEMENTAL.item(),
                    null,
                    null
        ...
        new EnchantedItem(
                        ...
                        new ItemStack[] {
                            null,
                            null,
                            SlimefunItems.LAVA_CRYSTAL.item(),
                            null,
                            SlimefunItems.STAFF_ELEMENTAL.item(),
                            null,
                            SlimefunItems.STAFF_ELEMENTAL.item(),
        ...
        new MultiTool(
                        ...
                        100,
                        Stream.concat(multiToolItems.stream(), additionalMultiToolItems.stream())
                                .toList())
                .register(plugin);
        ...
        new GoldIngot(itemGroups.resources, 4, SlimefunItems.GOLD_4K, RecipeType.SMELTERY, new ItemStack[] {
                    SlimefunItems.GOLD_DUST.item(), null, null, null, null, null, null, null, null
                })
                .setUseableInWorkbench(true)
                .register(plugin);
        ...
        new SolarHelmet(
                        ...
                        new ItemStack[] {
                            SlimefunItems.REINFORCED_ALLOY_INGOT.item(),
                            SlimefunItems.SOLAR_PANEL.item(),
                            SlimefunItems.REINFORCED_ALLOY_INGOT.item(),
                            SlimefunItems.REINFORCED_ALLOY_INGOT.item(),
                            null,
                            SlimefunItems.REINFORCED_ALLOY_INGOT.item(),
        ...
        new StormStaff(itemGroups.magicalGadgets, SlimefunItems.STAFF_STORM, RecipeType.ANCIENT_ALTAR, new ItemStack[] {
                    SlimefunItems.LIGHTNING_RUNE.item(),
                    SlimefunItems.ENDER_LUMP_3.item(),
                    SlimefunItems.LIGHTNING_RUNE.item(),
                    SlimefunItems.STAFF_WATER.item(),
                    SlimefunItems.MAGIC_SUGAR.item(),
                    SlimefunItems.STAFF_WIND.item(),
                    SlimefunItems.LIGHTNING_RUNE.item(),
                    SlimefunItems.ENDER_LUMP_3.item(),
                    SlimefunItems.LIGHTNING_RUNE.item()
                })
        ...
        new Talisman(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.COMMON_TALISMAN.item(),
                            new ItemStack(Material.ANVIL),
                            SlimefunItems.MAGIC_LUMP_3.item(),
                            null,
                            SlimefunItems.MAGIC_LUMP_3.item()
        ...
        new Talisman(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.SYNTHETIC_SAPPHIRE.item(),
                            SlimefunItems.COMMON_TALISMAN.item(),
                            SlimefunItems.MONSTER_JERKY.item(),
                            SlimefunItems.MAGIC_LUMP_3.item(),
                            null,
                            SlimefunItems.MAGIC_LUMP_3.item()
                        },
        ...
        new Talisman(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.MAGIC_LUMP_3.item(),
                            SlimefunItems.STAFF_WIND.item(),
                            SlimefunItems.TALISMAN_ANGEL.item(),
                            SlimefunItems.STAFF_WIND.item(),
                            SlimefunItems.MAGIC_LUMP_3.item(),
                            null,
                            SlimefunItems.MAGIC_LUMP_3.item()
        ...
        new Talisman(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.TALISMAN_WARRIOR.item(),
                            SlimefunItems.GILDED_IRON.item(),
                            SlimefunItems.MAGIC_LUMP_3.item(),
                            null,
                            SlimefunItems.MAGIC_LUMP_3.item()
        ...
        new Talisman(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.TALISMAN_MINER.item(),
        ...
        new Talisman(
                        ...
                        new ItemStack[] {
                            SlimefunItems.MAGIC_LUMP_3.item(),
                            SlimefunItems.MAGICAL_GLASS.item(),
                            SlimefunItems.MAGIC_LUMP_3.item(),
                            SlimefunItems.FILLED_FLASK_OF_KNOWLEDGE.item(),
                            SlimefunItems.TALISMAN_MAGICIAN.item(),
                            SlimefunItems.FILLED_FLASK_OF_KNOWLEDGE.item(),
                            SlimefunItems.MAGIC_LUMP_3.item(),
                            SlimefunItems.MAGICAL_GLASS.item(),
                            SlimefunItems.MAGIC_LUMP_3.item()
        ...
        new Talisman(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.MAGIC_LUMP_3.item(),
                            SlimefunItems.STAFF_WIND.item(),
                            SlimefunItems.TALISMAN_TRAVELLER.item(),
                            SlimefunItems.STAFF_WIND.item(),
                            SlimefunItems.MAGIC_LUMP_3.item(),
                            null,
                            SlimefunItems.MAGIC_LUMP_3.item()
        ...
        new Talisman(
                        ...
                        new ItemStack[] {
                            ...
                            null,
                            SlimefunItems.ENDER_LUMP_3.item(),
                            SlimefunItems.MAGIC_EYE_OF_ENDER.item(),
                            SlimefunItems.TALISMAN_MAGICIAN.item(),
                            SlimefunItems.MAGIC_EYE_OF_ENDER.item(),
                            SlimefunItems.ENDER_LUMP_3.item(),
                            null,
        ...
        new SlimefunItem(itemGroups.misc, SlimefunItems.BUTTER, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                    SlimefunItems.HEAVY_CREAM.item(),
                    SlimefunItems.SALT.item(),
                    null,
                    null,
                    null,
        ...
        registerArmorSet(
                ...
                new ItemStack[] {
                    SlimefunItems.GILDED_IRON_HELMET.item(),
                    SlimefunItems.GILDED_IRON_CHESTPLATE.item(),
                    SlimefunItems.GILDED_IRON_LEGGINGS.item(),
                    SlimefunItems.GILDED_IRON_BOOTS.item()
                },
                "GILDED_IRON",
                false,
                new PotionEffect[0][0],
        ...
        new SlimefunItem(
                        ...
                        new SlimefunItemStack(SlimefunItems.REINFORCED_CLOTH, 2).item())
                .register(plugin);
        ...
        new SlimefunItem(itemGroups.misc, SlimefunItems.PULVERIZED_ORE, RecipeType.ORE_CRUSHER, new ItemStack[] {
                    SlimefunItems.CRUSHED_ORE.item(), null, null, null, null, null, null, null, null
                })
                .register(plugin);

        new SlimefunItem(itemGroups.misc, SlimefunItems.PURE_ORE_CLUSTER, RecipeType.ORE_WASHER, new ItemStack[] {
                    SlimefunItems.PULVERIZED_ORE.item(), null, null, null, null, null, null, null, null
                })
                .register(plugin);
        ...
        new RadioactiveItem(
                        ...
                        RecipeType.ORE_CRUSHER,
                        new ItemStack[] {
                            SlimefunItems.PURE_ORE_CLUSTER.item(), null, null, null, null, null, null, null, null
                        })
                .register(plugin);
        ...
        new RadioactiveItem(
                        ...
                        RecipeType.ENHANCED_CRAFTING_TABLE,
                        new ItemStack[] {
                            SlimefunItems.TINY_URANIUM.item(),
                            SlimefunItems.TINY_URANIUM.item(),
                            SlimefunItems.TINY_URANIUM.item(),
                            SlimefunItems.TINY_URANIUM.item(),
                            SlimefunItems.TINY_URANIUM.item(),
        ...
        new RadioactiveItem(
                        ...
                        RecipeType.ENHANCED_CRAFTING_TABLE,
                        new ItemStack[] {
                            SlimefunItems.SMALL_URANIUM.item(),
                            SlimefunItems.SMALL_URANIUM.item(),
                            null,
                            SlimefunItems.SMALL_URANIUM.item(),
                            SlimefunItems.SMALL_URANIUM.item(),
        ...
        registerArmorSet(
                ...
                new ItemStack[] {
                    SlimefunItems.GOLDEN_HELMET_12K.item(),
                    SlimefunItems.GOLDEN_CHESTPLATE_12K.item(),
                    SlimefunItems.GOLDEN_LEGGINGS_12K.item(),
                    SlimefunItems.GOLDEN_BOOTS_12K.item()
                },
                "GOLD_12K",
                false,
                new PotionEffect[0][0],
        ...
        new Bandage(
                        ...
                        new SlimefunItemStack(SlimefunItems.RAG, 2).item(),
                        0)
                .register(plugin);
        ...
        new Bandage(
                        ...
                        new SlimefunItemStack(SlimefunItems.BANDAGE, 4).item(),
                        1)
                .register(plugin);
        ...
        new SlimefunBackpack(
                        ...
                        new ItemStack[] {
                            ...
                            new ItemStack(Material.LEATHER),
                            SlimefunItems.GOLD_10K.item(),
                            SlimefunItems.BACKPACK_SMALL.item(),
                            SlimefunItems.GOLD_10K.item(),
                            new ItemStack(Material.LEATHER),
                            new ItemStack(Material.LEATHER),
                            new ItemStack(Material.LEATHER)
        ...
        new SlimefunBackpack(
                        ...
                        new ItemStack[] {
                            ...
                            new ItemStack(Material.LEATHER),
                            SlimefunItems.GOLD_14K.item(),
                            SlimefunItems.BACKPACK_MEDIUM.item(),
                            SlimefunItems.GOLD_14K.item(),
                            new ItemStack(Material.LEATHER),
                            new ItemStack(Material.LEATHER),
                            new ItemStack(Material.LEATHER)
        ...
        new SlimefunBackpack(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.CLOTH.item(),
                            SlimefunItems.GOLD_16K.item(),
                            SlimefunItems.BACKPACK_LARGE.item(),
                            SlimefunItems.GOLD_16K.item(),
                            SlimefunItems.CLOTH.item(),
                            SlimefunItems.CLOTH.item(),
                            SlimefunItems.CLOTH.item()
        ...
        new SlimefunBackpack(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.GOLD_22K.item(),
                            new ItemStack(Material.LEATHER),
                            SlimefunItems.WOVEN_BACKPACK.item(),
                            new ItemStack(Material.LEATHER),
                            SlimefunItems.GOLD_22K.item(),
                            null,
                            SlimefunItems.GOLD_22K.item()
        ...
        new SlimefunBackpack(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.GOLD_24K.item(),
                            new ItemStack(Material.LEATHER),
                            SlimefunItems.GILDED_BACKPACK.item(),
                            new ItemStack(Material.LEATHER),
                            SlimefunItems.GOLD_24K.item(),
                            null,
                            SlimefunItems.GOLD_24K.item()
        ...
        new SlimefunItem(
                        ...
                        new ItemStack[] {
                            SlimefunItems.ENDER_LUMP_3.item(),
                            SlimefunItems.AIR_RUNE.item(),
                            SlimefunItems.ENDER_LUMP_3.item(),
                            SlimefunItems.EARTH_RUNE.item(),
                            SlimefunItems.NECROTIC_SKULL.item(),
                            SlimefunItems.FIRE_RUNE.item(),
                            SlimefunItems.ENDER_LUMP_3.item(),
                            SlimefunItems.WATER_RUNE.item(),
                            SlimefunItems.ENDER_LUMP_3.item()
                        })
                .register(plugin);
        ...
        new SlimefunItem(
                        ...
                        new ItemStack[] {
                            SlimefunItems.ENDER_LUMP_3.item(),
                            SlimefunItems.ENDER_RUNE.item(),
                            SlimefunItems.ENDER_LUMP_3.item(),
                            SlimefunItems.REINFORCED_PLATE.item(),
        ...
        new SoulboundBackpack(
                        ...
                        new ItemStack[] {
                            ...
                            null,
                            SlimefunItems.ENDER_LUMP_2.item(),
                            SlimefunItems.ESSENCE_OF_AFTERLIFE.item(),
                            SlimefunItems.WOVEN_BACKPACK.item(),
                            SlimefunItems.ESSENCE_OF_AFTERLIFE.item(),
                            SlimefunItems.ENDER_LUMP_2.item(),
                            null,
        ...
        new VanillaItem(
                        ...
                        RecipeType.ENHANCED_CRAFTING_TABLE,
                        new ItemStack[] {
                            SlimefunItems.GOLD_24K_BLOCK.item(),
                            SlimefunItems.GOLD_24K_BLOCK.item(),
                            SlimefunItems.GOLD_24K_BLOCK.item(),
                            SlimefunItems.GOLD_24K_BLOCK.item(),
                            new ItemStack(Material.APPLE),
        ...
        new RepairedSpawner(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.ESSENCE_OF_AFTERLIFE.item(),
                            SlimefunItems.FILLED_FLASK_OF_KNOWLEDGE.item(),
                            SlimefunItems.BROKEN_SPAWNER.item(),
                            SlimefunItems.FILLED_FLASK_OF_KNOWLEDGE.item(),
                            SlimefunItems.ESSENCE_OF_AFTERLIFE.item(),
                            SlimefunItems.FILLED_FLASK_OF_KNOWLEDGE.item(),
                            SlimefunItems.ENDER_RUNE.item()
        ...
        new EnhancedFurnace(itemGroups.basicMachines, 1, 1, 1, SlimefunItems.ENHANCED_FURNACE, new ItemStack[] {
                    ...
                    SlimefunItems.HEATING_COIL.item(),
                    null,
                    SlimefunItems.ELECTRIC_MOTOR.item(),
                    null
                })
        ...
        new EnhancedFurnace(itemGroups.basicMachines, 2, 1, 1, SlimefunItems.ENHANCED_FURNACE_2, new ItemStack[] {
                    ...
                    null,
                    SlimefunItems.BASIC_CIRCUIT_BOARD.item(),
                    SlimefunItems.ENHANCED_FURNACE.item(),
                    SlimefunItems.HEATING_COIL.item(),
                    null,
                    SlimefunItems.ELECTRIC_MOTOR.item(),
                    null
        ...
        new EnhancedFurnace(itemGroups.basicMachines, 2, 2, 1, SlimefunItems.ENHANCED_FURNACE_3, new ItemStack[] {
                    ...
                    null,
                    SlimefunItems.BASIC_CIRCUIT_BOARD.item(),
                    SlimefunItems.ENHANCED_FURNACE_2.item(),
                    SlimefunItems.HEATING_COIL.item(),
                    null,
                    SlimefunItems.ELECTRIC_MOTOR.item(),
                    null
        ...
        new EnhancedFurnace(itemGroups.basicMachines, 3, 2, 1, SlimefunItems.ENHANCED_FURNACE_4, new ItemStack[] {
                    ...
                    null,
                    SlimefunItems.BASIC_CIRCUIT_BOARD.item(),
                    SlimefunItems.ENHANCED_FURNACE_3.item(),
                    SlimefunItems.HEATING_COIL.item(),
                    null,
                    SlimefunItems.ELECTRIC_MOTOR.item(),
                    null
        ...
        new EnhancedFurnace(itemGroups.basicMachines, 3, 2, 2, SlimefunItems.ENHANCED_FURNACE_5, new ItemStack[] {
                    ...
                    null,
                    SlimefunItems.BASIC_CIRCUIT_BOARD.item(),
                    SlimefunItems.ENHANCED_FURNACE_4.item(),
                    SlimefunItems.HEATING_COIL.item(),
                    null,
                    SlimefunItems.ELECTRIC_MOTOR.item(),
                    null
        ...
        new EnhancedFurnace(itemGroups.basicMachines, 3, 3, 2, SlimefunItems.ENHANCED_FURNACE_6, new ItemStack[] {
                    ...
                    null,
                    SlimefunItems.BASIC_CIRCUIT_BOARD.item(),
                    SlimefunItems.ENHANCED_FURNACE_5.item(),
                    SlimefunItems.HEATING_COIL.item(),
                    null,
                    SlimefunItems.ELECTRIC_MOTOR.item(),
                    null
        ...
        new EnhancedFurnace(itemGroups.basicMachines, 4, 3, 2, SlimefunItems.ENHANCED_FURNACE_7, new ItemStack[] {
                    ...
                    null,
                    SlimefunItems.BASIC_CIRCUIT_BOARD.item(),
                    SlimefunItems.ENHANCED_FURNACE_6.item(),
                    SlimefunItems.HEATING_COIL.item(),
                    null,
                    SlimefunItems.ELECTRIC_MOTOR.item(),
                    null
        ...
        new EnhancedFurnace(itemGroups.basicMachines, 4, 4, 2, SlimefunItems.ENHANCED_FURNACE_8, new ItemStack[] {
                    ...
                    null,
                    SlimefunItems.BASIC_CIRCUIT_BOARD.item(),
                    SlimefunItems.ENHANCED_FURNACE_7.item(),
                    SlimefunItems.HEATING_COIL.item(),
                    null,
                    SlimefunItems.ELECTRIC_MOTOR.item(),
                    null
        ...
        new EnhancedFurnace(itemGroups.basicMachines, 5, 4, 2, SlimefunItems.ENHANCED_FURNACE_9, new ItemStack[] {
                    ...
                    null,
                    SlimefunItems.BASIC_CIRCUIT_BOARD.item(),
                    SlimefunItems.ENHANCED_FURNACE_8.item(),
                    SlimefunItems.HEATING_COIL.item(),
                    null,
                    SlimefunItems.ELECTRIC_MOTOR.item(),
                    null
        ...
        new EnhancedFurnace(itemGroups.basicMachines, 5, 5, 2, SlimefunItems.ENHANCED_FURNACE_10, new ItemStack[] {
                    ...
                    null,
                    SlimefunItems.BASIC_CIRCUIT_BOARD.item(),
                    SlimefunItems.ENHANCED_FURNACE_9.item(),
                    SlimefunItems.HEATING_COIL.item(),
                    null,
                    SlimefunItems.ELECTRIC_MOTOR.item(),
                    null
        ...
        new EnhancedFurnace(itemGroups.basicMachines, 5, 5, 3, SlimefunItems.ENHANCED_FURNACE_11, new ItemStack[] {
                    ...
                    null,
                    SlimefunItems.BASIC_CIRCUIT_BOARD.item(),
                    SlimefunItems.ENHANCED_FURNACE_10.item(),
                    SlimefunItems.HEATING_COIL.item(),
                    null,
                    SlimefunItems.ELECTRIC_MOTOR.item(),
                    null
        ...
        new EnhancedFurnace(itemGroups.basicMachines, 10, 10, 3, SlimefunItems.REINFORCED_FURNACE, new ItemStack[] {
                    ...
                    SlimefunItems.REINFORCED_ALLOY_INGOT.item(),
                    SlimefunItems.HEATING_COIL.item(),
                    SlimefunItems.ENHANCED_FURNACE_11.item(),
                    SlimefunItems.HEATING_COIL.item(),
                    SlimefunItems.REINFORCED_ALLOY_INGOT.item(),
                    SlimefunItems.ELECTRIC_MOTOR.item(),
                    SlimefunItems.REINFORCED_ALLOY_INGOT.item()
        ...
        new EnhancedFurnace(
                        itemGroups.basicMachines, 20, 10, 3, SlimefunItems.CARBONADO_EDGED_FURNACE, new ItemStack[] {
                            ...
                            SlimefunItems.CARBONADO.item(),
                            SlimefunItems.HEATING_COIL.item(),
                            SlimefunItems.REINFORCED_FURNACE.item(),
                            SlimefunItems.HEATING_COIL.item(),
                            SlimefunItems.CARBONADO.item(),
                            SlimefunItems.ELECTRIC_MOTOR.item(),
                            SlimefunItems.CARBONADO.item()
        ...
        new UnplaceableBlock(
                        ...
                        RecipeType.ENHANCED_CRAFTING_TABLE,
                        new ItemStack[] {
                            SlimefunItems.COPPER_WIRE.item(),
                            SlimefunItems.COPPER_WIRE.item(),
                            SlimefunItems.COPPER_WIRE.item(),
                            null,
                            SlimefunItems.ELECTRO_MAGNET.item(),
                            null,
                            SlimefunItems.COPPER_WIRE.item(),
                            SlimefunItems.COPPER_WIRE.item(),
                            SlimefunItems.COPPER_WIRE.item()
        ...
        new HiddenItem(
                        ...
                        RecipeType.INTERACT,
                        new ItemStack[] {
                            SlimefunItems.FLASK_OF_KNOWLEDGE.item(), null, null, null, null, null, null, null, null
                        })
                .register(plugin);
        ...
        new Juice(
                        ...
                        RecipeType.ENHANCED_CRAFTING_TABLE,
                        new ItemStack[] {
                            SlimefunItems.CHRISTMAS_MILK.item(),
        ...
        new Juice(
                        ...
                        RecipeType.ENHANCED_CRAFTING_TABLE,
                        new ItemStack[] {
                            SlimefunItems.APPLE_JUICE.item(),
                            new ItemStack(Material.SUGAR),
                            null,
                            null,
                            null,
        ...
        new Juice(
                        ...
                        RecipeType.SMELTERY,
                        new ItemStack[] {
                            SlimefunItems.CHRISTMAS_CHOCOLATE_MILK.item(),
                            null,
                            null,
                            null,
                            null,
                        ...
                        SlimefunItems.CHRISTMAS_HOT_CHOCOLATE.item())
                .register(plugin);
        ...
        new SlimefunItem(
                        ...
                        new ItemStack[] {
                            new ItemStack(Material.EGG),
                            new ItemStack(Material.SUGAR),
                            SlimefunItems.WHEAT_FLOUR.item(),
                            new ItemStack(Material.MILK_BUCKET),
                            null,
                            null,
                            null,
        ...
        new SlimefunItem(
                        ...
                        new ItemStack[] {
                            null,
                            SlimefunItems.CHRISTMAS_CARAMEL.item(),
                            null,
                            null,
                            new ItemStack(Material.APPLE),
                            null,
        ...
        new SlimefunItem(itemGroups.misc, SlimefunItems.REINFORCED_PLATE, RecipeType.COMPRESSOR, new ItemStack[] {
                    new SlimefunItemStack(SlimefunItems.REINFORCED_ALLOY_INGOT, 8).item(),
                    null,
                    null,
                    null,
                    null,
        ...
        new Cooler(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.CLOTH.item(),
                            SlimefunItems.ALUMINUM_INGOT.item(),
                            SlimefunItems.COOLING_UNIT.item(),
                            SlimefunItems.ALUMINUM_INGOT.item(),
                            SlimefunItems.ALUMINUM_INGOT.item(),
                            SlimefunItems.ALUMINUM_INGOT.item(),
                            SlimefunItems.ALUMINUM_INGOT.item()
        ...
        new Capacitor(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.REINFORCED_ALLOY_INGOT.item(),
                            new ItemStack(Material.REDSTONE),
                            SlimefunItems.BIG_CAPACITOR.item(),
                            new ItemStack(Material.REDSTONE),
                            SlimefunItems.REINFORCED_ALLOY_INGOT.item(),
                            SlimefunItems.REDSTONE_ALLOY.item(),
                            SlimefunItems.REINFORCED_ALLOY_INGOT.item()
        ...
        new Capacitor(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.CARBONADO_EDGED_CAPACITOR.item(),
                            new ItemStack(Material.NETHER_STAR),
                            SlimefunItems.CARBONADO.item(),
                            SlimefunItems.REDSTONE_ALLOY.item(),
                            SlimefunItems.CARBONADO.item()
        ...
        new SolarGenerator(
                        ...
                        RecipeType.ENHANCED_CRAFTING_TABLE,
                        new ItemStack[] {
                            SlimefunItems.SOLAR_GENERATOR.item(),
                            SlimefunItems.ALUMINUM_INGOT.item(),
                            SlimefunItems.SOLAR_GENERATOR.item(),
                            SlimefunItems.ALUMINUM_INGOT.item(),
                            new ItemStack(Material.REDSTONE),
        ...
        new SolarGenerator(
                        ...
                        RecipeType.ENHANCED_CRAFTING_TABLE,
                        new ItemStack[] {
                            SlimefunItems.SOLAR_GENERATOR_2.item(),
                            SlimefunItems.ALUMINUM_INGOT.item(),
                            SlimefunItems.SOLAR_GENERATOR_2.item(),
                            SlimefunItems.ALUMINUM_INGOT.item(),
                            SlimefunItems.CARBONADO.item(),
        ...
        new SolarGenerator(
                        ...
                        RecipeType.ENHANCED_CRAFTING_TABLE,
                        new ItemStack[] {
                            SlimefunItems.SOLAR_GENERATOR_3.item(),
        ...
        new ElectricFurnace(
                        ...
                        new ItemStack[] {
                            ...
                            null,
                            SlimefunItems.GILDED_IRON.item(),
                            SlimefunItems.ELECTRIC_FURNACE.item(),
                            SlimefunItems.GILDED_IRON.item(),
                            SlimefunItems.GILDED_IRON.item(),
                            SlimefunItems.HEATING_COIL.item(),
                            SlimefunItems.GILDED_IRON.item()
        ...
        new ElectricFurnace(
                        ...
                        new ItemStack[] {
                            ...
                            null,
                            SlimefunItems.STEEL_INGOT.item(),
                            SlimefunItems.ELECTRIC_FURNACE_2.item(),
                            SlimefunItems.STEEL_INGOT.item(),
                            SlimefunItems.GILDED_IRON.item(),
                            SlimefunItems.HEATING_COIL.item(),
                            SlimefunItems.GILDED_IRON.item()
        ...
        new ElectricGoldPan(
                        ...
                        new ItemStack[] {
                            ...
                            null,
                            new ItemStack(Material.IRON_INGOT),
                            SlimefunItems.ELECTRIC_GOLD_PAN.item(),
                            new ItemStack(Material.IRON_INGOT),
                            SlimefunItems.DURALUMIN_INGOT.item(),
                            SlimefunItems.DURALUMIN_INGOT.item(),
                            SlimefunItems.DURALUMIN_INGOT.item()
        ...
        new ElectricGoldPan(
                        ...
                        new ItemStack[] {
                            ...
                            null,
                            SlimefunItems.ELECTRIC_MOTOR.item(),
                            SlimefunItems.ELECTRIC_GOLD_PAN_2.item(),
                            SlimefunItems.ELECTRIC_MOTOR.item(),
                            SlimefunItems.COBALT_INGOT.item(),
                            SlimefunItems.BLISTERING_INGOT_3.item(),
                            SlimefunItems.COBALT_INGOT.item()
        ...
        new ElectricDustWasher(
                        ...
                        new ItemStack[] {
                            ...
                            null,
                            SlimefunItems.ELECTRO_MAGNET.item(),
                            SlimefunItems.ELECTRIC_DUST_WASHER.item(),
                            SlimefunItems.ELECTRO_MAGNET.item(),
                            SlimefunItems.DAMASCUS_STEEL_INGOT.item(),
                            SlimefunItems.DAMASCUS_STEEL_INGOT.item(),
                            SlimefunItems.DAMASCUS_STEEL_INGOT.item()
        ...
        new ElectricDustWasher(
                        ...
                        new ItemStack[] {
                            ...
                            null,
                            SlimefunItems.ELECTRO_MAGNET.item(),
                            SlimefunItems.ELECTRIC_DUST_WASHER_2.item(),
                            SlimefunItems.ELECTRO_MAGNET.item(),
                            SlimefunItems.CORINTHIAN_BRONZE_INGOT.item(),
                            SlimefunItems.BLISTERING_INGOT_3.item(),
                            SlimefunItems.CORINTHIAN_BRONZE_INGOT.item()
        ...
        new ElectricIngotFactory(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.GILDED_IRON.item(),
                            SlimefunItems.HEATING_COIL.item(),
                            SlimefunItems.ELECTRIC_INGOT_FACTORY.item(),
                            SlimefunItems.HEATING_COIL.item(),
                            SlimefunItems.BRASS_INGOT.item(),
                            SlimefunItems.ELECTRIC_MOTOR.item(),
                            SlimefunItems.BRASS_INGOT.item()
        ...
        new ElectricIngotFactory(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.GILDED_IRON.item(),
                            SlimefunItems.HEATING_COIL.item(),
                            SlimefunItems.ELECTRIC_INGOT_FACTORY_2.item(),
                            SlimefunItems.HEATING_COIL.item(),
                            SlimefunItems.BRASS_INGOT.item(),
                            SlimefunItems.BLISTERING_INGOT_3.item(),
                            SlimefunItems.BRASS_INGOT.item()
        ...
        new ElectrifiedCrucible(
                        ...
                        new ItemStack[] {
                            SlimefunItems.CORINTHIAN_BRONZE_INGOT.item(),
                            SlimefunItems.ELECTRIFIED_CRUCIBLE.item(),
                            SlimefunItems.CORINTHIAN_BRONZE_INGOT.item(),
                            SlimefunItems.DAMASCUS_STEEL_INGOT.item(),
                            SlimefunItems.ELECTRIC_MOTOR.item(),
                            SlimefunItems.DAMASCUS_STEEL_INGOT.item(),
        ...
        new ElectrifiedCrucible(
                        ...
                        new ItemStack[] {
                            SlimefunItems.CORINTHIAN_BRONZE_INGOT.item(),
                            SlimefunItems.ELECTRIFIED_CRUCIBLE_2.item(),
                            SlimefunItems.CORINTHIAN_BRONZE_INGOT.item(),
                            SlimefunItems.STEEL_PLATE.item(),
                            SlimefunItems.POWER_CRYSTAL.item(),
                            SlimefunItems.STEEL_PLATE.item(),
        ...
        new ElectricOreGrinder(
                        ...
                        new ItemStack[] {
                            ...
                            null,
                            SlimefunItems.HEATING_COIL.item(),
                            SlimefunItems.ELECTRIC_ORE_GRINDER.item(),
                            SlimefunItems.HEATING_COIL.item(),
                            SlimefunItems.GILDED_IRON.item(),
                            SlimefunItems.BLISTERING_INGOT_3.item(),
                            SlimefunItems.GILDED_IRON.item()
        ...
        new HeatedPressureChamber(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.LEAD_INGOT.item(),
                            SlimefunItems.LEAD_INGOT.item(),
                            SlimefunItems.HEATED_PRESSURE_CHAMBER.item(),
                            SlimefunItems.LEAD_INGOT.item(),
                            SlimefunItems.REINFORCED_ALLOY_INGOT.item(),
                            SlimefunItems.HEATING_COIL.item(),
                            SlimefunItems.REINFORCED_ALLOY_INGOT.item()
        ...
        new CoalGenerator(
                        ...
                        new ItemStack[] {
                            ...
                            new ItemStack(Material.MAGMA_BLOCK),
                            SlimefunItems.HARDENED_METAL_INGOT.item(),
                            SlimefunItems.COAL_GENERATOR.item(),
                            SlimefunItems.HARDENED_METAL_INGOT.item(),
                            null,
                            SlimefunItems.ELECTRIC_MOTOR.item(),
                            null
        ...
        new ElectricPress(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.ELECTRIC_PRESS.item(),
                            new ItemStack(Material.STICKY_PISTON),
                            SlimefunItems.DAMASCUS_STEEL_INGOT.item(),
                            SlimefunItems.BIG_CAPACITOR.item(),
                            SlimefunItems.DAMASCUS_STEEL_INGOT.item(),
        ...
        new AutoEnchanter(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.REINFORCED_PLATE.item(),
                            SlimefunItems.BLISTERING_INGOT_3.item(),
                            SlimefunItems.AUTO_ENCHANTER.item(),
                            SlimefunItems.BLISTERING_INGOT_3.item(),
                            SlimefunItems.WITHER_PROOF_OBSIDIAN.item(),
                            SlimefunItems.SYNTHETIC_DIAMOND.item(),
                            SlimefunItems.WITHER_PROOF_OBSIDIAN.item()
        ...
        new AutoDisenchanter(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.REINFORCED_PLATE.item(),
                            SlimefunItems.BLISTERING_INGOT_3.item(),
                            SlimefunItems.AUTO_DISENCHANTER.item(),
                            SlimefunItems.BLISTERING_INGOT_3.item(),
                            SlimefunItems.WITHER_PROOF_OBSIDIAN.item(),
                            SlimefunItems.BIG_CAPACITOR.item(),
                            SlimefunItems.WITHER_PROOF_OBSIDIAN.item()
        ...
        new GPSTransmitter(
                ...
                RecipeType.ENHANCED_CRAFTING_TABLE,
                new ItemStack[] {
                    SlimefunItems.GPS_TRANSMITTER.item(),
                    SlimefunItems.BRONZE_INGOT.item(),
                    SlimefunItems.GPS_TRANSMITTER.item(),
                    SlimefunItems.BRONZE_INGOT.item(),
                    SlimefunItems.CARBON.item(),
        ...
        new GPSTransmitter(
                ...
                RecipeType.ENHANCED_CRAFTING_TABLE,
                new ItemStack[] {
                    SlimefunItems.GPS_TRANSMITTER_2.item(),
                    SlimefunItems.CORINTHIAN_BRONZE_INGOT.item(),
                    SlimefunItems.GPS_TRANSMITTER_2.item(),
                    SlimefunItems.CORINTHIAN_BRONZE_INGOT.item(),
                    SlimefunItems.CARBONADO.item(),
        ...
        new GPSTransmitter(
                ...
                RecipeType.ENHANCED_CRAFTING_TABLE,
                new ItemStack[] {
                    SlimefunItems.GPS_TRANSMITTER_3.item(),
                    SlimefunItems.BLISTERING_INGOT_3.item(),
                    SlimefunItems.GPS_TRANSMITTER_3.item(),
                    SlimefunItems.NICKEL_INGOT.item(),
                    SlimefunItems.CARBONADO.item(),
        ...
        new ProgrammableAndroid(
                        ...
                        new ItemStack[] {
                            SlimefunItems.PLASTIC_SHEET.item(),
                            SlimefunItems.ANDROID_MEMORY_CORE.item(),
                            SlimefunItems.PLASTIC_SHEET.item(),
                            SlimefunItems.COAL_GENERATOR.item(),
                            SlimefunItems.ELECTRIC_MOTOR.item(),
                            new ItemStack(Material.CHEST),
        ...
        new MinerAndroid(
                        ...
                        new ItemStack[] {
                            ...
                            null,
                            new ItemStack(Material.DIAMOND_PICKAXE),
                            SlimefunItems.PROGRAMMABLE_ANDROID.item(),
                            new ItemStack(Material.DIAMOND_PICKAXE),
                            null,
                            SlimefunItems.ELECTRIC_MOTOR.item(),
                            null
        ...
        new ProgrammableAndroid(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.ANDROID_MEMORY_CORE.item(),
                            SlimefunItems.PLASTIC_SHEET.item(),
                            SlimefunItems.COMBUSTION_REACTOR.item(),
                            SlimefunItems.PROGRAMMABLE_ANDROID.item(),
                            new ItemStack(Material.CHEST),
                            SlimefunItems.PLASTIC_SHEET.item(),
                            SlimefunItems.POWER_CRYSTAL.item(),
        ...
        new FishermanAndroid(
                        ...
                        new ItemStack[] {
                            ...
                            null,
                            new ItemStack(Material.FISHING_ROD),
                            SlimefunItems.PROGRAMMABLE_ANDROID_2.item(),
                            new ItemStack(Material.FISHING_ROD),
                            null,
                            SlimefunItems.ELECTRIC_MOTOR.item(),
                            null
        ...
        new ProgrammableAndroid(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.ANDROID_MEMORY_CORE.item(),
                            SlimefunItems.PLASTIC_SHEET.item(),
                            SlimefunItems.NUCLEAR_REACTOR.item(),
                            SlimefunItems.PROGRAMMABLE_ANDROID_2.item(),
                            new ItemStack(Material.CHEST),
                            SlimefunItems.BLISTERING_INGOT_3.item(),
                            SlimefunItems.POWER_CRYSTAL.item(),
        ...
        new FishermanAndroid(
                        ...
                        new ItemStack[] {
                            ...
                            null,
                            new ItemStack(Material.FISHING_ROD),
                            SlimefunItems.PROGRAMMABLE_ANDROID_3.item(),
                            new ItemStack(Material.FISHING_ROD),
                            null,
                            SlimefunItems.ELECTRIC_MOTOR.item(),
                            null
        ...
        new SlimefunItem(
                        ...
                        RecipeType.ANCIENT_ALTAR,
                        new ItemStack[] {
                            SlimefunItems.FLASK_OF_KNOWLEDGE.item(),
                            SlimefunItems.ELYTRA_SCALE.item(),
                            SlimefunItems.FLASK_OF_KNOWLEDGE.item(),
                            SlimefunItems.FLASK_OF_KNOWLEDGE.item(),
                            new ItemStack(Material.ELYTRA),
        ...
        new RainbowBlock(
                        ...
                        new ItemStack[] {
                            ...
                            new ItemStack(Material.WHITE_WOOL),
                            new ItemStack(Material.WHITE_WOOL),
                            SlimefunItems.RAINBOW_RUNE.item(),
                            new ItemStack(Material.WHITE_WOOL),
                            new ItemStack(Material.WHITE_WOOL),
                            new ItemStack(Material.WHITE_WOOL),
                            new ItemStack(Material.WHITE_WOOL)
                        },
                        new SlimefunItemStack(SlimefunItems.RAINBOW_WOOL, 8).item(),
        ...
        new RainbowBlock(
                        ...
                        new SlimefunItemStack(SlimefunItems.RAINBOW_GLASS, 8).item(),
        ...
        new RainbowBlock(
                        ...
                        new SlimefunItemStack(SlimefunItems.RAINBOW_GLASS_PANE, 8).item(),
        ...
        new RainbowBlock(
                        ...
                        new SlimefunItemStack(SlimefunItems.RAINBOW_CLAY, 8).item(),
        ...
        new RainbowBlock(
                        ...
                        new SlimefunItemStack(SlimefunItems.RAINBOW_CONCRETE, 8).item(),
        ...
        new RainbowBlock(
                        ...
                        new SlimefunItemStack(SlimefunItems.RAINBOW_GLAZED_TERRACOTTA, 8).item(),
        ...
        new RainbowBlock(
                        ...
                        new ItemStack[] {
                            new ItemStack(Material.RED_DYE),
                            SlimefunItems.CHRISTMAS_COOKIE.item(),
                        ...
                        new SlimefunItemStack(SlimefunItems.RAINBOW_WOOL_XMAS, 2).item(),
        ...
        new RainbowBlock(
                        ...
                        new SlimefunItemStack(SlimefunItems.RAINBOW_GLASS_XMAS, 2).item(),
        ...
        new RainbowBlock(
                        ...
                        new SlimefunItemStack(SlimefunItems.RAINBOW_GLASS_PANE_XMAS, 2).item(),
        ...
        new RainbowBlock(
                        ...
                        new SlimefunItemStack(SlimefunItems.RAINBOW_CLAY_XMAS, 2).item(),
        ...
        new RainbowBlock(
                        ...
                        new SlimefunItemStack(SlimefunItems.RAINBOW_CONCRETE_XMAS, 2).item(),
        ...
        new RainbowBlock(
                        ...
                        new SlimefunItemStack(SlimefunItems.RAINBOW_GLAZED_TERRACOTTA_XMAS, 2).item(),
        ...
        new RainbowBlock(
                        ...
                        new SlimefunItemStack(SlimefunItems.RAINBOW_WOOL_VALENTINE, 2).item(),
        ...
        new RainbowBlock(
                        ...
                        new SlimefunItemStack(SlimefunItems.RAINBOW_GLASS_VALENTINE, 2).item(),
        ...
        new RainbowBlock(
                        ...
                        new SlimefunItemStack(SlimefunItems.RAINBOW_GLASS_PANE_VALENTINE, 2).item(),
        ...
        new RainbowBlock(
                        ...
                        new SlimefunItemStack(SlimefunItems.RAINBOW_CLAY_VALENTINE, 2).item(),
        ...
        new RainbowBlock(
                        ...
                        new SlimefunItemStack(SlimefunItems.RAINBOW_CONCRETE_VALENTINE, 2).item(),
        ...
        new RainbowBlock(
                        ...
                        new SlimefunItemStack(SlimefunItems.RAINBOW_GLAZED_TERRACOTTA_VALENTINE, 2).item(),
        ...
        new RainbowBlock(
                        ...
                        new SlimefunItemStack(SlimefunItems.RAINBOW_WOOL_HALLOWEEN, 2).item(),
        ...
        new RainbowBlock(
                        ...
                        new SlimefunItemStack(SlimefunItems.RAINBOW_GLASS_HALLOWEEN, 2).item(),
        ...
        new RainbowBlock(
                        ...
                        new SlimefunItemStack(SlimefunItems.RAINBOW_GLASS_PANE_HALLOWEEN, 2).item(),
        ...
        new RainbowBlock(
                        ...
                        new SlimefunItemStack(SlimefunItems.RAINBOW_CLAY_HALLOWEEN, 2).item(),
        ...
        new RainbowBlock(
                        ...
                        new SlimefunItemStack(SlimefunItems.RAINBOW_CONCRETE_HALLOWEEN, 2).item(),
        ...
        new RainbowBlock(
                        ...
                        new SlimefunItemStack(SlimefunItems.RAINBOW_GLAZED_TERRACOTTA_HALLOWEEN, 2).item(),
        ...
        new PortableGEOScanner(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.ELECTRO_MAGNET.item(),
                            SlimefunItems.STEEL_INGOT.item(),
                            SlimefunItems.GPS_MARKER_TOOL.item(),
                            SlimefunItems.STEEL_INGOT.item(),
                            SlimefunItems.SOLDER_INGOT.item(),
                            SlimefunItems.ELECTRIC_MOTOR.item(),
                            SlimefunItems.SOLDER_INGOT.item()
        ...
        new SlimefunItem(itemGroups.resources, SlimefunItems.FUEL_BUCKET, RecipeType.REFINERY, new ItemStack[] {
                    null, null, null, null, SlimefunItems.OIL_BUCKET.item(), null, null, null, null
                })
                .register(plugin);
        ...
        new LavaGenerator(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.CORINTHIAN_BRONZE_INGOT.item(),
                            SlimefunItems.COMPRESSED_CARBON.item(),
                            SlimefunItems.LAVA_GENERATOR.item(),
                            SlimefunItems.COMPRESSED_CARBON.item(),
                            SlimefunItems.HEATING_COIL.item(),
                            SlimefunItems.COMPRESSED_CARBON.item(),
                            SlimefunItems.HEATING_COIL.item()
        ...
        new Teleporter(
                        ...
                        RecipeType.ENHANCED_CRAFTING_TABLE,
                        new ItemStack[] {
                            SlimefunItems.GPS_TELEPORTER_PYLON.item(),
                            SlimefunItems.REINFORCED_ALLOY_INGOT.item(),
                            SlimefunItems.GPS_TELEPORTER_PYLON.item(),
                            SlimefunItems.ELECTRO_MAGNET.item(),
                            SlimefunItems.GPS_CONTROL_PANEL.item(),
                            SlimefunItems.ELECTRO_MAGNET.item(),
                            SlimefunItems.GPS_TELEPORTER_PYLON.item(),
                            SlimefunItems.REINFORCED_ALLOY_INGOT.item(),
                            SlimefunItems.GPS_TELEPORTER_PYLON.item()
        ...
        new PortableTeleporter(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.ELECTRO_MAGNET.item(),
                            SlimefunItems.REINFORCED_PLATE.item(),
                            SlimefunItems.GPS_TELEPORTATION_MATRIX.item(),
                            SlimefunItems.REINFORCED_PLATE.item(),
                            SlimefunItems.BLISTERING_INGOT_3.item(),
                            SlimefunItems.MEDIUM_CAPACITOR.item(),
                            SlimefunItems.BLISTERING_INGOT_3.item()
        ...
        new PersonalActivationPlate(
                        ...
                        new ItemStack[] {
                            ...
                            null,
                            SlimefunItems.COBALT_INGOT.item(),
                            SlimefunItems.GPS_ACTIVATION_DEVICE_SHARED.item(),
                            SlimefunItems.COBALT_INGOT.item(),
                            null,
                            SlimefunItems.LEAD_INGOT.item(),
                            null
        ...
        new InfusedHopper(
                        ...
                        new ItemStack[] {
                            ...
                            new ItemStack(Material.HOPPER),
                            SlimefunItems.ENDER_RUNE.item(),
                            SlimefunItems.INFUSED_MAGNET.item(),
                            SlimefunItems.ENDER_RUNE.item(),
                            new ItemStack(Material.HOPPER),
                            SlimefunItems.EARTH_RUNE.item(),
                            new ItemStack(Material.OBSIDIAN)
        ...
        new RadioactiveItem(
                        ...
                        RecipeType.HEATED_PRESSURE_CHAMBER,
                        new ItemStack[] {
                            SlimefunItems.BLISTERING_INGOT.item(),
                            SlimefunItems.CARBONADO.item(),
                            null,
                            null,
                            null,
        ...
        new RadioactiveItem(
                        ...
                        RecipeType.HEATED_PRESSURE_CHAMBER,
                        new ItemStack[] {
                            SlimefunItems.BLISTERING_INGOT_2.item(),
                            new ItemStack(Material.NETHER_STAR),
                            null,
                            null,
                            null,
        ...
        new FoodFabricator(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.HARDENED_METAL_INGOT.item(),
                            SlimefunItems.ELECTRIC_MOTOR.item(),
                            SlimefunItems.FOOD_FABRICATOR.item(),
                            SlimefunItems.ELECTRIC_MOTOR.item(),
                            null,
                            SlimefunItems.ELECTRO_MAGNET.item(),
                            null
        ...
        new AnimalGrowthAccelerator(
                        ...
                        new ItemStack[] {
                            ...
                            null,
                            SlimefunItems.ELECTRIC_MOTOR.item(),
                            SlimefunItems.WHEAT_ORGANIC_FOOD.item(),
                            SlimefunItems.ELECTRIC_MOTOR.item(),
                            SlimefunItems.REINFORCED_ALLOY_INGOT.item(),
                            SlimefunItems.AUTO_BREEDER.item(),
                            SlimefunItems.REINFORCED_ALLOY_INGOT.item()
                        })
                .register(plugin);
        ...
        new FoodComposter(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.HARDENED_METAL_INGOT.item(),
                            SlimefunItems.ELECTRIC_MOTOR.item(),
                            SlimefunItems.FOOD_COMPOSTER.item(),
                            SlimefunItems.ELECTRIC_MOTOR.item(),
                            null,
                            SlimefunItems.ELECTRO_MAGNET.item(),
                            null
        ...
        new CropGrowthAccelerator(
                ...
                new ItemStack[] {
                    ...
                    null,
                    SlimefunItems.ELECTRIC_MOTOR.item(),
                    SlimefunItems.PROGRAMMABLE_ANDROID_FARMER.item(),
                    SlimefunItems.ELECTRIC_MOTOR.item(),
                    SlimefunItems.ELECTRO_MAGNET.item(),
                    SlimefunItems.ANIMAL_GROWTH_ACCELERATOR.item(),
                    SlimefunItems.ELECTRO_MAGNET.item()
                }) {
        ...
        new CropGrowthAccelerator(
                ...
                new ItemStack[] {
                    ...
                    null,
                    SlimefunItems.ELECTRIC_MOTOR.item(),
                    SlimefunItems.CROP_GROWTH_ACCELERATOR.item(),
                    SlimefunItems.ELECTRIC_MOTOR.item(),
                    SlimefunItems.ELECTRO_MAGNET.item(),
                    SlimefunItems.ADVANCED_CIRCUIT_BOARD.item(),
                    SlimefunItems.ELECTRO_MAGNET.item()
        ...
        new CoolantCell(
                        ...
                        RecipeType.HEATED_PRESSURE_CHAMBER,
                        new ItemStack[] {
                            SlimefunItems.ENRICHED_NETHER_ICE.item(), null, null, null, null, null, null, null, null
                        },
        ...
        new CargoManager(
                        ...
                        new ItemStack[] {
                            null,
                            SlimefunItems.HOLOGRAM_PROJECTOR.item(),
                            null,
                            SlimefunItems.REINFORCED_PLATE.item(),
                            SlimefunItems.CARGO_MOTOR.item(),
                            SlimefunItems.REINFORCED_PLATE.item(),
                            SlimefunItems.ALUMINUM_BRONZE_INGOT.item(),
                            SlimefunItems.ANDROID_MEMORY_CORE.item(),
                            SlimefunItems.ALUMINUM_BRONZE_INGOT.item()
        ...
        new CargoInputNode(
                        ...
                        new ItemStack[] {
                            ...
                            null,
                            SlimefunItems.BILLON_INGOT.item(),
                            SlimefunItems.CARGO_CONNECTOR_NODE.item(),
                            SlimefunItems.BILLON_INGOT.item(),
                            null,
                            new ItemStack(Material.HOPPER),
                            null
        ...
        new AdvancedCargoOutputNode(
                        ...
                        new ItemStack[] {
                            ...
                            null,
                            SlimefunItems.COBALT_INGOT.item(),
                            SlimefunItems.CARGO_OUTPUT_NODE.item(),
                            SlimefunItems.COBALT_INGOT.item(),
                            null,
                            SlimefunItems.CARGO_MOTOR.item(),
                            null
        ...
        new TrashCan(itemGroups.cargo, SlimefunItems.TRASH_CAN, RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[] {
                    null,
                    SlimefunItems.PORTABLE_DUSTBIN.item(),
                    null,
                    SlimefunItems.LEAD_INGOT.item(),
                    SlimefunItems.CARGO_MOTOR.item(),
                    SlimefunItems.LEAD_INGOT.item(),
        ...
        new CarbonPress(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.CARBONADO.item(),
                            SlimefunItems.CARBON.item(),
                            SlimefunItems.CARBON_PRESS.item(),
                            SlimefunItems.CARBON.item(),
                            SlimefunItems.HEATING_COIL.item(),
                            SlimefunItems.ELECTRO_MAGNET.item(),
                            SlimefunItems.HEATING_COIL.item()
        ...
        new CarbonPress(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.CARBONADO.item(),
                            SlimefunItems.REINFORCED_ALLOY_INGOT.item(),
                            SlimefunItems.CARBON_PRESS_2.item(),
                            SlimefunItems.REINFORCED_ALLOY_INGOT.item(),
                            SlimefunItems.HEATING_COIL.item(),
                            SlimefunItems.ELECTRO_MAGNET.item(),
                            SlimefunItems.HEATING_COIL.item()
        ...
        new ElectricSmeltery(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.DAMASCUS_STEEL_INGOT.item(),
                            SlimefunItems.HEATING_COIL.item(),
                            SlimefunItems.ELECTRIC_SMELTERY.item(),
                            SlimefunItems.HEATING_COIL.item(),
                            SlimefunItems.GILDED_IRON.item(),
                            SlimefunItems.ELECTRIC_MOTOR.item(),
                            SlimefunItems.GILDED_IRON.item()
        ...
        new VillagerRune(
                        ...
                        new ItemStack[] {
                            ...
                            SlimefunItems.STRANGE_NETHER_GOO.item(),
                            SlimefunItems.FIRE_RUNE.item(),
                            SlimefunItems.STRANGE_NETHER_GOO.item(),
                            new ItemStack(Material.CRYING_OBSIDIAN),
                            SlimefunItems.MAGICAL_GLASS.item(),
        ...
        new StrangeNetherGoo(
                        ...
                        new ItemStack[] {
                            ...
                            null,
                            null,
                            ItemStackFactory.create(HeadTexture.PIGLIN_HEAD.getAsItemStack(), "&fPiglin"),
                            null,
                            null,
                            null,
                            null
        ...
        if (minecraftVersion.isAtLeast(1, 17)) {
        ...
        new VanillaAutoCrafter(
                        ...
                        new ItemStack[] {
                            ...
                            null,
                            new ItemStack(Material.CRAFTING_TABLE),
                            SlimefunItems.CRAFTING_MOTOR.item(),
                            new ItemStack(Material.CRAFTING_TABLE),
                            null,
                            SlimefunItems.ELECTRIC_MOTOR.item(),
                            null
    ...
    private static void registerArmorSet(
            ItemGroup itemGroup,
            SlimefunItemStack baseComponent,
            ItemStack[] items,
            String idSyntax,
            boolean vanilla,
